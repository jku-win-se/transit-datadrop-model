...
/**
 * This is the item provider adapter for a {@link datadropModel.Artifact} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArtifactItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Artifact_type_feature",
								"_UI_Artifact_type"),
						DatadropModelPackage.Literals.ARTIFACT__TYPE, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Artifact_name_feature",
								"_UI_Artifact_type"),
						DatadropModelPackage.Literals.ARTIFACT__NAME, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addFilesPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Artifact_files_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Artifact_files_feature",
								"_UI_Artifact_type"),
						DatadropModelPackage.Literals.ARTIFACT__FILES, true, false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DatadropModelPackage.Literals.ARTIFACT__FILES);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		case DatadropModelPackage.ARTIFACT__TYPE:
		case DatadropModelPackage.ARTIFACT__NAME:
			fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
			return;
		case DatadropModelPackage.ARTIFACT__FILES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(DatadropModelPackage.Literals.ARTIFACT__FILES,
				DatadropModelFactory.eINSTANCE.createFile()));
	}
